...
public class JwtUtils {
    ...
    public static String genJwtToken(String username){
        return createJWT(username,username,300*60*1000);
    }
   ...
   /* public static void main(String[] args) throws InterruptedException {
    ...
    public static void main(String[] args) {
        String str = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJsaXNodW8iLCJzdWIiOiJsaXNodW8iLCJpc3MiOiJsaXNodW8iLCJpYXQiOjE3MTg3MzM2MDMsImV4cCI6MTcxODczNzIwM30.N5TlY407rIglnDNIRc1LXQReqVHIVhedW1whMrS5OpU";
        Claims claims1 = parseJWT(str);
        System.out.println(claims1);
    }
