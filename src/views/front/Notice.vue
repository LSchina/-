<template>
  <div id="notice_container">
    ...
    <div style="width: 100%;height: 5%;background-color: white;display: flex;">
      ...
      <div style="margin: auto;font-size: 1.2rem;font-family: 华文中宋">社团公告</div>
    </div>
    ...
    <div style="margin-top: 1rem">
      <van-cell-group inset>
        ...
        >
          <template #button>
            <van-button size="small" type="primary" @click="queryNotice">
      ...
      <ul style="margin: auto;width: 94%;height: 100%">
        <li v-for="item in tableDate.value" :key="item"
          ...
          <div style="width: 100%;height: 100%">
              ...
              <div  style="font-size: 0.8rem;margin-top: 0.5rem;color: #909091">
                {{item.comment}}
            </div>
            <div style="">
    ...
    <div style="margin-top: 0rem">
      <van-pagination v-model="query.pageNo" :total-items="total" @change="queryNotice">
        <template #prev-text>
...
const queryNotice = () => {
instance.post('/messages/noticeList',query).then(res =>{
